...
(function() {
	...
	tinymce.create('tinymce.plugins.ContextMenu', {
		...
		_getMenu : function(ed,url) {
			...
			m.add({title : 'clker.gallery', icon : 'clker', cmd : 'mceclker'});
			m.add({title : 'imgmap.desc', icon : 'images/tinymce_button.gif', cmd : 'mceimgmapPopup'});
			
			m.addSeparator();
			m.add({title : 'Insert P Tag', icon : '', cmd : 'jwlPtagsButton'});
			m.add({title : 'Insert Line Break', icon : '', cmd : 'jwlLineBreakButton'});
