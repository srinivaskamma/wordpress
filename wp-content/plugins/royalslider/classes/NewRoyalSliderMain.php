...
class NewRoyalSliderMain {
	...
	function __construct( $file ) {
		...
		self::$update_checker = new RSPluginUpdateChecker_1_3(
		    'http://dimsemenov.com/private/rsupdate-json.php',
		     $file,
		    'newroyalslider'
		);
		...
		add_filter('puc_request_url_args-newroyalslider', array(&$this, 'upd_url_args'), 10,2);
		add_filter('puc_request_info_options-newroyalslider', array(&$this, 'upd_req_options'), 10,2);
	...
	function upd_url_args($url) {
		global $wpdb;
		$arr = array(
			'rsv' => NEW_ROYALSLIDER_WP_VERSION,
	...
	function upd_req_options($options) {
