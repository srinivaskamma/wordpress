...
$result =  '<span class="wizylike_count">' . $wizylike->likes_count . '</span>';
$result .= '<span class="wizylike_linebreaker last"></span>';
$result .= '<span class="wizylike_like_unlike" onclick="'.$button_onclick.'">' . $button_txt . '</span>';
